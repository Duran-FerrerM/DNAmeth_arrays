...
if(!interactive()){
  ...
  project <- "/media/mduran/Marti_SSD1/WORK/CLL_ERIC_Subsets/QC_ERIC.HCB.ICGC.EPIC"
  ...
  #EPIC
  samp.sheet.path.EPIC <- "/media/mduran/Marti_SSD1/WORK/CLL_ERIC_Subsets/Data/SampleSheets_QC/ERIC.HCB.ICGC.EPIC.csv"
  baseDir.EPIC <- "/media/mduran/Marti_SSD1/WORK/IDATS/IDATS_850k/"
