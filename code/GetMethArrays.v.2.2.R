...
if(!interactive()){
  ...
  #EPIC
  samp.sheet.path.EPIC <- "/media/mduran/Marti_SSD1/WORK/ALCL/DATA_Andrew/Final_Data/20210501-Feldman-ALCL-Methyl-MetaData-To-Send_Arranged4QC.csv"
  baseDir.EPIC <- "/media/mduran/Marti_SSD1/WORK/ALCL/DATA_Andrew/Final_Data/20220102-Feldman-Methylation-Raw-Data-Files-To-Send/"
